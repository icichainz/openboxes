                ...
                <table style="">
                    <thead>
                        <tr class="odd">
                            ...
                            <th class="center"><warehouse:message code="orderItem.quotedDeliveryDate.label"/></th>
                            <th class="center"><warehouse:message code="orderItem.currentDeliveryDate.label"/></th>
                    ...
                    <tbody>
                        ...
                        <g:each var="orderItem" in="${order?.listOrderItems()}">
                            <tr class="${(i++ % 2) == 0 ? 'even' : 'odd'}">
                                ...
                                <td class="center middle">
                                    <g:formatDate date="${orderItem?.quotedDeliveryDate}" format="dd/MMM/yyyy"/>
                                </td>
                                <td class="center middle">
                                    <g:formatDate date="${orderItem?.currentDeliveryDate}" format="dd/MMM/yyyy"/>
                                </td>
                        ...
                        <g:form action="purchaseOrder" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <g:jqueryDatePicker id="quotedDeliveryDate" name="quotedDeliveryDate" value=""
